...
export default function FemmesPage() {
  ...
  const categories = ["Robes", "Hauts", "Pantalons", "Vestes", "Pulls", "Jupes"]
  const sizes = ["XS", "S", "M", "L", "XL", "34", "36", "38", "40", "42"]
  const colors = ["Noir", "Blanc", "Gris", "Beige", "Rose", "Bleu", "Rouge", "Vert"]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-serif font-bold text-foreground">Collection Femmes</h1>
            </div>
            <div className="flex items-center space-x-4">
